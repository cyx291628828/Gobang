...
public class GobangConstant {
	...
	map.put("011112", 40000); // 冲四
	map.put("101112", 40000); // 冲四
	map.put("110112", 40000); // 冲四
	map.put("111012", 40000); // 冲四
	map.put("111102", 40000); // 冲四
	...
	map.put("001112", 5000);// 眠三
	map.put("010112", 5000);// 眠三
	map.put("100112", 5000);// 眠三
	map.put("011012", 5000);// 眠三
	map.put("101012", 5000);// 眠三
	map.put("110012", 5000);// 眠三
	map.put("011102", 5000);// 眠三
	map.put("101102", 5000);// 眠三
	map.put("110102", 5000);// 眠三
	map.put("111002", 5000);// 眠三
	...
	map.put("000112", 2000);// 眠二
	map.put("001012", 2000);// 眠二
	map.put("010012", 2000);// 眠二
	map.put("100012", 2000);// 眠二
	map.put("001102", 2000);// 眠二
	map.put("010102", 2000);// 眠二
	map.put("100102", 2000);// 眠二
	map.put("011002", 2000);// 眠二
	map.put("101002", 2000);// 眠二
	map.put("110002", 2000);// 眠二

	map.put("010000", 900);// 活一
	map.put("001000", 1500);// 活一
	map.put("000100", 1500);// 活一
	map.put("000010", 900);// 活一
	...
	map.put("000012", 700);// 眠一
	map.put("000102", 700);// 眠一
	map.put("001002", 700);// 眠一
	map.put("010002", 700);// 眠一
	map.put("100002", 700);// 眠一
